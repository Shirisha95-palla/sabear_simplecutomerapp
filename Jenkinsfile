pipeline { // Opening pipeline
    ...
    environment { // Opening environment
        ...
        NEXUS_REPOSITORY = "Maven-snapshot25/" // Is this the correct Nexus repository name? Sonarqube is usually a tool, not a Nexus repo. Common ones are 'maven-releases', 'maven-snapshots'.
        ...
        steps {
            withSonarQubeEnv('sonarqube') {
                sh '''${SCANNER_HOME}/bin/sonar-scanner \
                    ...
                    -Dsonar.sources=/root/.jenkins/workspace/$JOB_NAME/src/ \
